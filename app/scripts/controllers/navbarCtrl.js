angular
	...
	.controller('NavbarController', ['AuthFactory', 'userLoginFactory', 'spLoginFactory', 'adminLoginFactory', 'fbFactory', '$location', 'userService', 'spService', 'adminService', function (AuthFactory, userLoginFactory, spLoginFactory, adminLoginFactory, fbFactory, $location, userService, spService, adminService) {
