	...
	.controller('FaqController', [function () {
		...
		vm.general = [
			...
			},
			{
				...
				a: 'We have a variety of different ways to file complaints. Please feel free to directly contact us via phone (xxx-xxx-xxxx) or via our contact page with whatever complaints you may have. We will work hard to find the resolution as soon as possible.'
			},
			{
